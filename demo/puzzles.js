...
function checkPswd() {
    ...
    switch (password) {
        ...
        case ('shrek3'):
        case ('shrek4'):
            let shrekNote = confirm("You found Anisa's cubby - isn't it great? It seems super cluttered, but maybe there's something in here that can help you find somewhere to look next.");
            if (shrekNote) {
        ...
        case ('fiftynineminutes'):
            ...
            break;
        case ('youcompleteme'):
            let wifiNote = confirm("Connecting... connecting... connected! Looks like there's a recent WhatsApp message from someone. Seems like it could be helpful? But it's a bit difficult to tell.");
            if (wifiNote) {
        ...
        case ('dunkin'):
        case ('dunkindonuts'):
            let ddNote = confirm("Of course Anisa went to Dunkin. What else did you expect? Maybe there's something there that can help us.");
            if (ddNote) {
